    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            ...
            <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">{{Auth::check() ? Auth::user()->name : 'User'}}</span><span class="user-status">{{Auth::check() ? Auth::user()->role : ''}}</span></div>
                    <span class="avatar"><img class="round" src="{{ (Auth::check() && !empty(Auth::user()->profile_image) ) ? asset('images/profile/user-upload/'.Auth::user()->profile_image) : asset('app-assets/images/portrait/small/avatar-s-11.jpg') }} " alt="avatar" height="40" width="40" /><span class="avatar-status-online"></span></span>
                </a>
